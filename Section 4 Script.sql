REM   Script: Udemy Section 4 Script
REM   Udemy Section 4 Script
...
select name, salary, 25, 'test', salary - salary*0.10, to_char(hire_date), rownum
from employee;
...
-- Selects name, phone number, and salary from employee table
...
-- Selects name and salary from employee department and also shows a 20% increase from salary


-- Column and table aliases

select id, name, salary AS old_salary, salary * 1.2 new_salary
from employee;

--Column names changed with underscores

select id, name, salary AS "Old Salary", salary * 1.2 "New Salary"
from employee;

--Column names changed using strings
